# Generated by Django 2.1.2 on 2018-11-22 11:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executionhash', models.CharField(blank=True, default=uuid.uuid4, max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameters', to='testcore.TestExecution')),
            ],
        ),
        migrations.CreateModel(
            name='TestType',
